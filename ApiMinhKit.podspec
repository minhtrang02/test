...
Pod::Spec.new do |s|
  s.name             = 'ApiMinhKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ApiMinhKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Minh Trang Nguyen/ApiMinhKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Minh Trang Nguyen' => 'minh.trangnguyen@easyflex.nl' }
  s.source           = { :git => 'https://github.com/Minh Trang Nguyen/ApiMinhKit.git', :tag => s.version.to_s }
